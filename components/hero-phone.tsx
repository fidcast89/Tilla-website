      ...
      <div className="relative w-full flex items-center justify-center">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[24px] border-[10px] border-gray-800 bg-gray-800 shadow-2xl">
            ...
            <div className="relative h-[360px] w-[540px] overflow-hidden bg-gray-900 p-2">
              {isClient && (
                <Image
                  src="/images/dash_tablet.png"
                  alt="Tilla Tablet Dashboard"
                  fill
          ...
          <motion.div
            ...
            className="absolute -inset-2 rounded-[32px] bg-blue-500/20 blur-xl -z-10"
          ></motion.div>
        </motion.div>
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -inset-1 rounded-[40px] bg-green-500/20 blur-xl -z-10"
          ></motion.div>
        </motion.div>
      </div>
    </div>
