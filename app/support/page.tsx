  ...
  const articles = [
    {
      ...
      title: "Getting Started with iHustle POS",
      category: "getting-started",
      summary: "Learn the basics of setting up and using iHustle POS for your business.",
      content: `
        <h2>Getting Started with iHustle POS</h2>
        <p>Welcome to iHustle POS! This guide will help you get started with the app and set up your business.</p>
    ...
    },
    {
      ...
      category: "sales",
      summary: "Learn how to create and manage sales transactions in iHustle POS.",
      content: `
        <h2>How to Process Sales</h2>
        <p>Processing sales in iHustle POS is quick and easy. Follow these steps to complete a transaction.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <p>Effective inventory management is crucial for your business. Here's how to manage your products in iHustle POS.</p>
        ...
        <p>iHustle POS automatically updates stock levels when you make sales. You can also manually adjust stock from the product details page.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <p>Credit sales allow you to sell products to customers who will pay later. Here's how to manage credit sales in iHustle POS.</p>
    ...
    },
    {
      ...
      content: `
        ...
        <p>Building relationships with your customers is essential. Here's how to manage customer information in iHustle POS.</p>
          ...
          >
            ...
            <div className="bg-[#00C696]/5 rounded-xl p-5">
              ...
              <div className="space-y-2">
                <Link href="mailto:support@ihustlepos.com">
